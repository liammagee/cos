 ...
 */
public class LinkIndicators extends Capability {
    Plan handleIndicatorLinkPlan = null; //---- Plan HandleIndicatorLink
    { //---- qua Capability
        //---- Capabilities
        /**
         ...
         * documentation.
         */
        addGoal( handleIndicatorLinkPlan = new Plan( "HandleIndicatorLink", new Goal [] {
            new Goal( "handleIndicatorLink" ) {
                public States execute(Data data) {
                     System.out.println("PLAN: Handle Indicator Link");
                    return PASSED;
                }
            //---- End of Goal handleIndicatorLink
            }
        } ) );
